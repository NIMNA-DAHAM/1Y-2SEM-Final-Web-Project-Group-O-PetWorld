...
<body class="bg-gray-50">
    ...
    <section class="py-12 container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <a href="food.php?category_id=<?php echo $category['category_id']; ?>">
                <?php 
                $bg_colors = ['bg-green-100', 'bg-yellow-100', 'bg-blue-100', 'bg-red-100'];
                $text_colors = ['text-green-700', 'text-yellow-700', 'text-blue-700', 'text-red-700'];
                $hover_colors = ['hover:bg-green-200', 'hover:bg-yellow-200', 'hover:bg-blue-200', 'hover:bg-red-200'];
                $index = $category['category_id'] % 4;
                ?>
                <div
                    class="<?php echo $bg_colors[$index]; ?> p-6 rounded-lg shadow <?php echo $hover_colors[$index]; ?> transition">
                    <h3 class="font-semibold <?php echo $text_colors[$index]; ?> text-lg">
    ...
    <section class="py-12 container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition duration-300">
                ...
                <div class="p-4">
                    <h3 class="font-bold text-lg mb-1"><?php echo $product['name']; ?></h3>
                    <p class="text-gray-600 text-sm mb-2"><?php echo substr($product['description'], 0, 50); ?>...</p>
        ...
        <div class="text-center mt-8">
            <a href="food.php"
                class="inline-block bg-green-600 text-white font-bold py-2 px-6 rounded hover:bg-green-700 transition">View
                All Items</a>
        </div>
    ...
    <section class="py-12 bg-green-600 text-white">
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-green-700 p-6 rounded-lg shadow hover:shadow-lg transition">
                    <div class="flex items-center mb-4">
                        <div>
                            <h4 class="font-bold">Nish H.</h4>
                    ...
                    <p>"I've been able to trade my extra garden produce for homemade bread and jam. It's amazing to
                        connect with my neighbors this way!"</p>
                </div>
                ...
                <div class="bg-green-700 p-6 rounded-lg shadow hover:shadow-lg transition">
                    ...
                    <p>"As a small-scale farmer, this platform helps me sell excess produce directly to my community. No
                        middlemen, fair prices."</p>
                </div>
                ...
                <div class="bg-green-700 p-6 rounded-lg shadow hover:shadow-lg transition">
                    <div class="flex items-center mb-4">
                        <div>
                            <h4 class="font-bold">Shashi Y.</h4>
                            <div class="flex text-yellow-300">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                    ...
                    <p>"Found amazing organic ingredients for my home cooking at prices much better than the
                        supermarket. Will definitely use again!"</p>
                </div>
    ...
    <section class="py-16 bg-gray-800 text-white">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl mb-8 max-w-2xl mx-auto">Sign up today and start trading fresh, local food with people in
                your area.</p>
