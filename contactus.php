...
<head>
    ...
    <title>Pet World - Contact Us</title>
...
<body class="bg-gray-50">
    ...
    <section class="bg-green-600 text-white py-20 text-center">
        ...
        <p class="text-lg mb-6">We'd love to hear from you!</p>
    </section>
        ...
        <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
            ...
            <form class="space-y-6">
                ...
                <div class="text-center">
                    <button type="submit"
                        class="bg-green-600 text-white px-6 py-3 rounded-md hover:bg-green-700 transition">Send
                        Message</button>
                </div>
            </form>
        </div>
        ...
        <div class="fixed inset-0 bg-black bg-opacity-75 z-50 hidden" id="mobileMenu">
            <div class="bg-green-600 h-full w-3/4 max-w-sm p-4">
                ...
                <nav class="space-y-4">
                    ...
                    <a href="aboutus.php" class="block py-2 px-4 hover:bg-green-700 rounded">About Us</a>
                    <a href="contactus.php" class="block py-2 px-4 bg-green-700 rounded">Contact Us</a>
                    <?php if (is_logged_in()): ?>
